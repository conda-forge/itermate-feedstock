...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/itermate-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14292&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/itermate-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `itermate` can be installed with:

```
conda install itermate
```

It is possible to list all of the versions of `itermate` available on your platform with:
